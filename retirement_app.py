    ...
    st.markdown("""
        <div style='background-color: #1F2937; padding: 15px; border-radius: 8px; 
            ...
            <p style='color: #E5E7EB; margin: 0; font-size: 14px; line-height: 1.6;'>
                ...
                നനിങ്ങളുടെ അനന്തരാവകാശികൾക്കായി മാറ്റിവെക്കാൻ ആഗ്രഹിക്കുന്ന തുക ഇവിടെ രേഖപ്പെടുത്തുക. നിങ്ങൾ കണക്കാക്കുന്ന കാലയളവ് വരെ ജീവിച്ചാൽ, ഈ തുക അതിന്റെ പൂർണ്ണ മൂല്യത്തിൽ തന്നെ അവർക്ക് ലഭ്യമാകും.
            </p>
        </div>
        """, unsafe_allow_html=True)
